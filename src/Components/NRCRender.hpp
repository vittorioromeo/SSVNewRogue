...
public:
    NRCRender(sses::Entity& mE, NRGame& mGame, Body& mBody)
        : sses::Component{mE}, game(mGame), body(mBody)
    {
    }
    ...
    {
        sprites.emplace_back(FWD(mArgs)...);
    }
    ...
    inline void setRotation(float mDegrees)
    {
    ...
    inline void setScaleWithBody(bool mScaleWithBody)
    {
        scaleWithBody = mScaleWithBody;
    }
